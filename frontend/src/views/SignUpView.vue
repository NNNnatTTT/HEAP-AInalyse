    ...
    <div class="max-w-md w-full space-y-8">
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-white/80">
            ...
            <router-link to="/login" class="text-white hover:text-white font-medium relative group transition-colors duration-200 ml-1">
                Sign in here
                <span class="absolute left-0 bottom-0 w-0 h-0.5 bg-gradient-to-r from-pink-400 to-yellow-400 transition-all duration-300 group-hover:w-full"></span>
            </router-link>
        </p>
      </div>
            ...
            <div class="mt-2">
              <div class="flex space-x-1">
                <div 
                  v-for="i in 4" 
                  :key="i"
                  class="h-1 w-1/4 rounded-full transition-colors"
